...
public:
	...
	int find(const char* src, const size_t& begin = 0)const;
	int find(const String& src, const size_t& begin = 0)const;
	int rfind(const char* src)const;
	int rfind(const String& src)const;
